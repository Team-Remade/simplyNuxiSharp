...
public class ZN_FastNoiseLiteViewer
{
	// Engine object used for calling engine methods
	protected Control _object;

	public ZN_FastNoiseLiteViewer() : this(NativeName)
	{
	}
	protected ZN_FastNoiseLiteViewer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ZN_FastNoiseLiteViewer(Variant variant) : this((Control) variant)
	{
	}
	protected ZN_FastNoiseLiteViewer([NotNull] Control @object)
	{
		_object = @object;
	}

	public static implicit operator Control(ZN_FastNoiseLiteViewer self) => self?._object;
	public static implicit operator Variant(ZN_FastNoiseLiteViewer self) => self?._object;
	public static explicit operator ZN_FastNoiseLiteViewer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "ZN_FastNoiseLiteViewer";
