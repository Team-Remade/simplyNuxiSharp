...
public class ZN_EditorInspectorPlugin
{
	// Engine object used for calling engine methods
	protected EditorInspectorPlugin _object;

	public ZN_EditorInspectorPlugin() : this(NativeName)
	{
	}
	protected ZN_EditorInspectorPlugin(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ZN_EditorInspectorPlugin(Variant variant) : this((EditorInspectorPlugin) variant)
	{
	}
	protected ZN_EditorInspectorPlugin([NotNull] EditorInspectorPlugin @object)
	{
		_object = @object;
	}

	public static implicit operator EditorInspectorPlugin(ZN_EditorInspectorPlugin self) => self?._object;
	public static implicit operator Variant(ZN_EditorInspectorPlugin self) => self?._object;
	public static explicit operator ZN_EditorInspectorPlugin(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "ZN_EditorInspectorPlugin";
