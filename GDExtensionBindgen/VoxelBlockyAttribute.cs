...
public class VoxelBlockyAttribute
{
	// Engine object used for calling engine methods
	protected Resource _object;

	public VoxelBlockyAttribute() : this(NativeName)
	{
	}
	protected VoxelBlockyAttribute(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelBlockyAttribute(Variant variant) : this((Resource) variant)
	{
	}
	protected VoxelBlockyAttribute([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(VoxelBlockyAttribute self) => self?._object;
	public static implicit operator Variant(VoxelBlockyAttribute self) => self?._object;
	public static explicit operator VoxelBlockyAttribute(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	public class MethodName : Resource.MethodName
	{
		...
		public static readonly StringName IsRotation = "is_rotation";
	}
	...
	private static readonly StringName NativeName = "VoxelBlockyAttribute";

	#region Integer Constants

	public const long MaxValues = 256L;
	...
	public Godot.StringName GetAttributeName()
	{
		return (Godot.StringName)_object.Call(MethodName.GetAttributeName);
	}

	public int GetDefaultValue()
	{
		return (int)_object.Call(MethodName.GetDefaultValue);
	}
	...
	{
		return (bool)_object.Call(MethodName.IsRotation);
	}
