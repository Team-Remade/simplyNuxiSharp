...
public class VoxelInstanceLibraryItem
{
	// Engine object used for calling engine methods
	protected Resource _object;

	public VoxelInstanceLibraryItem() : this(NativeName)
	{
	}
	protected VoxelInstanceLibraryItem(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelInstanceLibraryItem(Variant variant) : this((Resource) variant)
	{
	}
	protected VoxelInstanceLibraryItem([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(VoxelInstanceLibraryItem self) => self?._object;
	public static implicit operator Variant(VoxelInstanceLibraryItem self) => self?._object;
	public static explicit operator VoxelInstanceLibraryItem(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : Resource.PropertyName
	{
		public static readonly StringName Name = "name";
		public static readonly StringName LodIndex = "lod_index";
		public static readonly StringName Generator = "generator";
		public static readonly StringName Persistent = "persistent";
		public static readonly StringName FloatingSdfThreshold = "floating_sdf_threshold";
		public static readonly StringName FloatingSdfOffsetAlongNormal = "floating_sdf_offset_along_normal";
	}
	...
	public class MethodName : Resource.MethodName
	{
		...
		public static readonly StringName SetLodIndex = "set_lod_index";
		public static readonly StringName GetLodIndex = "get_lod_index";
		public static readonly StringName SetGenerator = "set_generator";
		public static readonly StringName GetGenerator = "get_generator";
		public static readonly StringName SetPersistent = "set_persistent";
		public static readonly StringName IsPersistent = "is_persistent";
		public static readonly StringName SetFloatingSdfThreshold = "set_floating_sdf_threshold";
		public static readonly StringName GetFloatingSdfThreshold = "get_floating_sdf_threshold";
		public static readonly StringName SetFloatingSdfOffsetAlongNormal = "set_floating_sdf_offset_along_normal";
		public static readonly StringName GetFloatingSdfOffsetAlongNormal = "get_floating_sdf_offset_along_normal";
	}
	...
	private static readonly StringName NativeName = "VoxelInstanceLibraryItem";

	#region Properties

	public string Name
	{
		get => (string)_object.Get(PropertyName.Name);
		set => _object.Set(PropertyName.Name, value);
	}

	public int LodIndex
	{
		get => (int)_object.Get(PropertyName.LodIndex);
		set => _object.Set(PropertyName.LodIndex, value);
	}

	public VoxelInstanceGenerator Generator
	{
		get => (VoxelInstanceGenerator)_object.Get(PropertyName.Generator);
		set => _object.Set(PropertyName.Generator, value);
	}

	public bool Persistent
	{
		get => (bool)_object.Get(PropertyName.Persistent);
		set => _object.Set(PropertyName.Persistent, value);
	}

	public float FloatingSdfThreshold
	{
		get => (float)_object.Get(PropertyName.FloatingSdfThreshold);
		set => _object.Set(PropertyName.FloatingSdfThreshold, value);
	}

	public float FloatingSdfOffsetAlongNormal
	{
		get => (float)_object.Get(PropertyName.FloatingSdfOffsetAlongNormal);
		set => _object.Set(PropertyName.FloatingSdfOffsetAlongNormal, value);
	}
	...
	{
		_object.Call(MethodName.SetItemName, @name);
	}

	public string GetItemName()
	{
		return (string)_object.Call(MethodName.GetItemName);
	}

	public void SetLodIndex(int @lod)
	{
		_object.Call(MethodName.SetLodIndex, @lod);
	}

	public int GetLodIndex()
	{
		return (int)_object.Call(MethodName.GetLodIndex);
	}

	public void SetGenerator(VoxelInstanceGenerator @generator)
	{
		_object.Call(MethodName.SetGenerator, @generator);
	}

	public VoxelInstanceGenerator GetGenerator()
	{
		return (VoxelInstanceGenerator)_object.Call(MethodName.GetGenerator);
	}

	public void SetPersistent(bool @persistent)
	{
		_object.Call(MethodName.SetPersistent, @persistent);
	}

	public bool IsPersistent()
	{
		return (bool)_object.Call(MethodName.IsPersistent);
	}

	public void SetFloatingSdfThreshold(float @sd)
	{
		_object.Call(MethodName.SetFloatingSdfThreshold, @sd);
	}

	public float GetFloatingSdfThreshold()
	{
		return (float)_object.Call(MethodName.GetFloatingSdfThreshold);
	}

	public void SetFloatingSdfOffsetAlongNormal(float @sd)
	{
		_object.Call(MethodName.SetFloatingSdfOffsetAlongNormal, @sd);
	}

	public float GetFloatingSdfOffsetAlongNormal()
	{
		return (float)_object.Call(MethodName.GetFloatingSdfOffsetAlongNormal);
	}
