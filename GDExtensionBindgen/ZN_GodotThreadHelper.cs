...
public class ZN_GodotThreadHelper
{
	// Engine object used for calling engine methods
	protected GodotObject _object;

	public ZN_GodotThreadHelper() : this(NativeName)
	{
	}
	protected ZN_GodotThreadHelper(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ZN_GodotThreadHelper(Variant variant) : this((GodotObject) variant)
	{
	}
	protected ZN_GodotThreadHelper([NotNull] GodotObject @object)
	{
		_object = @object;
	}

	public static implicit operator GodotObject(ZN_GodotThreadHelper self) => self?._object;
	public static implicit operator Variant(ZN_GodotThreadHelper self) => self?._object;
	public static explicit operator ZN_GodotThreadHelper(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "ZN_GodotThreadHelper";

	#region Methods

	public void Run()
	{
		_object.Call(MethodName.Run);
	}
