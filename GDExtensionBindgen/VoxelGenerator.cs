...
public class VoxelGenerator
{
	...
	public VoxelGenerator() : this(NativeName)
	{
	}
	protected VoxelGenerator(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelGenerator(Variant variant) : this((Resource) variant)
	{
	}
	protected VoxelGenerator([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(VoxelGenerator self) => self?._object;
	public static implicit operator Variant(VoxelGenerator self) => self?._object;
	public static explicit operator VoxelGenerator(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	{
		public static readonly StringName GenerateBlock = "generate_block";
	}
	...
	private static readonly StringName NativeName = "VoxelGenerator";
	...
	public void GenerateBlock(VoxelBuffer @out_buffer, Godot.Vector3 @origin_in_voxels, int @lod)
	{
		_object.Call(MethodName.GenerateBlock, @out_buffer, @origin_in_voxels, @lod);
	}
