...
public class VoxelInstanceComponent
{
	// Engine object used for calling engine methods
	protected Node _object;

	public VoxelInstanceComponent() : this(NativeName)
	{
	}
	protected VoxelInstanceComponent(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelInstanceComponent(Variant variant) : this((Node) variant)
	{
	}
	protected VoxelInstanceComponent([NotNull] Node @object)
	{
		_object = @object;
	}

	public static implicit operator Node(VoxelInstanceComponent self) => self?._object;
	public static implicit operator Variant(VoxelInstanceComponent self) => self?._object;
	public static explicit operator VoxelInstanceComponent(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelInstanceComponent";
