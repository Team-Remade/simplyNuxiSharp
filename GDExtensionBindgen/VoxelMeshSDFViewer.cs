...
public class VoxelMeshSDFViewer
{
	// Engine object used for calling engine methods
	protected VBoxContainer _object;

	public VoxelMeshSDFViewer() : this(NativeName)
	{
	}
	protected VoxelMeshSDFViewer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelMeshSDFViewer(Variant variant) : this((VBoxContainer) variant)
	{
	}
	protected VoxelMeshSDFViewer([NotNull] VBoxContainer @object)
	{
		_object = @object;
	}

	public static implicit operator VBoxContainer(VoxelMeshSDFViewer self) => self?._object;
	public static implicit operator Variant(VoxelMeshSDFViewer self) => self?._object;
	public static explicit operator VoxelMeshSDFViewer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelMeshSDFViewer";
