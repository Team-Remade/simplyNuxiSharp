...
public class VoxelInstanceLibrary
{
	// Engine object used for calling engine methods
	protected Resource _object;

	public VoxelInstanceLibrary() : this(NativeName)
	{
	}
	protected VoxelInstanceLibrary(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelInstanceLibrary(Variant variant) : this((Resource) variant)
	{
	}
	protected VoxelInstanceLibrary([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(VoxelInstanceLibrary self) => self?._object;
	public static implicit operator Variant(VoxelInstanceLibrary self) => self?._object;
	public static explicit operator VoxelInstanceLibrary(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : Resource.PropertyName
	{
		public static readonly StringName SelectedItem = "_selected_item";
	...
	public class MethodName : Resource.MethodName
	{
		...
		public static readonly StringName GetAllItemIds = "get_all_item_ids";
	}
	...
	private static readonly StringName NativeName = "VoxelInstanceLibrary";

	#region Integer Constants

	public const long MaxId = 65535L;

	#endregion

	#region Properties

	public VoxelInstanceLibraryItem SelectedItem
	{
		get => (VoxelInstanceLibraryItem)_object.Get(PropertyName.SelectedItem);
		set => _object.Set(PropertyName.SelectedItem, value);
	}
	...
	public void AddItem(int @id, VoxelInstanceLibraryItem @item)
	{
		_object.Call(MethodName.AddItem, @id, @item);
	}

	public void RemoveItem(int @id)
	{
		_object.Call(MethodName.RemoveItem, @id);
	}
	...
	{
		return (int)_object.Call(MethodName.FindItemByName, @name);
	}

	public VoxelInstanceLibraryItem GetItem(int @id)
	{
		return (VoxelInstanceLibraryItem)_object.Call(MethodName.GetItem, @id);
	}

	public int[] GetAllItemIds()
	{
		return (int[])_object.Call(MethodName.GetAllItemIds);
	}
