...
public class VoxelTerrainEditorTaskIndicator
{
	// Engine object used for calling engine methods
	protected ScrollContainer _object;

	public VoxelTerrainEditorTaskIndicator() : this(NativeName)
	{
	}
	protected VoxelTerrainEditorTaskIndicator(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelTerrainEditorTaskIndicator(Variant variant) : this((ScrollContainer) variant)
	{
	}
	protected VoxelTerrainEditorTaskIndicator([NotNull] ScrollContainer @object)
	{
		_object = @object;
	}

	public static implicit operator ScrollContainer(VoxelTerrainEditorTaskIndicator self) => self?._object;
	public static implicit operator Variant(VoxelTerrainEditorTaskIndicator self) => self?._object;
	public static explicit operator VoxelTerrainEditorTaskIndicator(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : ScrollContainer.PropertyName
	{

	}

	public class MethodName : ScrollContainer.MethodName
	{

	}

	public class SignalName : ScrollContainer.SignalName
	{

	}

	private static readonly StringName NativeName = "VoxelTerrainEditorTaskIndicator";

	#region Inherited Properties

	public bool FollowFocus
	{
		get => _object.FollowFocus;
		set => _object.FollowFocus = value;
	}

	public bool DrawFocusBorder
	{
		get => _object.DrawFocusBorder;
		set => _object.DrawFocusBorder = value;
	}

	public int ScrollHorizontal
	{
		get => _object.ScrollHorizontal;
		set => _object.ScrollHorizontal = value;
	}

	public int ScrollVertical
	{
		get => _object.ScrollVertical;
		set => _object.ScrollVertical = value;
	}

	public float ScrollHorizontalCustomStep
	{
		get => _object.ScrollHorizontalCustomStep;
		set => _object.ScrollHorizontalCustomStep = value;
	}

	public float ScrollVerticalCustomStep
	{
		get => _object.ScrollVerticalCustomStep;
		set => _object.ScrollVerticalCustomStep = value;
	}

	public int HorizontalScrollMode
	{
		get => (int)_object.HorizontalScrollMode;
		set => _object.HorizontalScrollMode = (Godot.ScrollContainer.ScrollMode)value;
	}

	public int VerticalScrollMode
	{
		get => (int)_object.VerticalScrollMode;
		set => _object.VerticalScrollMode = (Godot.ScrollContainer.ScrollMode)value;
	}

	public int ScrollDeadzone
	{
		get => _object.ScrollDeadzone;
		set => _object.ScrollDeadzone = value;
	}

	public int ScrollHintMode
	{
		get => (int)_object.ScrollHintMode;
		set => _object.ScrollHintMode = (Godot.ScrollContainer.ScrollHintModeEnum)value;
	}

	public bool TileScrollHint
	{
		get => _object.TileScrollHint;
		set => _object.TileScrollHint = value;
	}
	...
	{
		_object.SetHScroll(@value);
	}

	public int GetHScroll()
	{
		return _object.GetHScroll();
	}

	public void SetVScroll(int @value)
	{
		_object.SetVScroll(@value);
	}

	public int GetVScroll()
	{
		return _object.GetVScroll();
	}

	public void SetHorizontalCustomStep(float @value)
	{
		_object.SetHorizontalCustomStep(@value);
	}

	public float GetHorizontalCustomStep()
	{
		return _object.GetHorizontalCustomStep();
	}

	public void SetVerticalCustomStep(float @value)
	{
		_object.SetVerticalCustomStep(@value);
	}

	public float GetVerticalCustomStep()
	{
		return _object.GetVerticalCustomStep();
	}

	public void SetHorizontalScrollMode(ScrollContainer.ScrollMode @enable)
	{
		_object.SetHorizontalScrollMode(@enable);
	}

	public ScrollContainer.ScrollMode GetHorizontalScrollMode()
	{
		return _object.GetHorizontalScrollMode();
	}

	public void SetVerticalScrollMode(ScrollContainer.ScrollMode @enable)
	{
		_object.SetVerticalScrollMode(@enable);
	}

	public ScrollContainer.ScrollMode GetVerticalScrollMode()
	{
		return _object.GetVerticalScrollMode();
	}

	public void SetDeadzone(int @deadzone)
	{
		_object.SetDeadzone(@deadzone);
	}

	public int GetDeadzone()
	{
		return _object.GetDeadzone();
	}

	public void SetScrollHintMode(ScrollContainer.ScrollHintModeEnum @scroll_hint_mode)
	{
		_object.SetScrollHintMode(@scroll_hint_mode);
	}

	public ScrollContainer.ScrollHintModeEnum GetScrollHintMode()
	{
		return _object.GetScrollHintMode();
	}

	public void SetTileScrollHint(bool @tile_scroll_hint)
	{
		_object.SetTileScrollHint(@tile_scroll_hint);
	}

	public bool IsScrollHintTiled()
	{
		return _object.IsScrollHintTiled();
	}

	public void SetFollowFocus(bool @enabled)
	{
		_object.SetFollowFocus(@enabled);
	}

	public bool IsFollowingFocus()
	{
		return _object.IsFollowingFocus();
	}

	public HScrollBar GetHScrollBar()
	{
		return _object.GetHScrollBar();
	}

	public VScrollBar GetVScrollBar()
	{
		return _object.GetVScrollBar();
	}

	public void EnsureControlVisible(Control @control)
	{
		_object.EnsureControlVisible(@control);
	}

	public void SetDrawFocusBorder(bool @draw)
	{
		_object.SetDrawFocusBorder(@draw);
	}

	public bool GetDrawFocusBorder()
	{
		return _object.GetDrawFocusBorder();
	}
	...
	public event Action ScrollStarted
	{
		add
		{
			Connect(SignalName.ScrollStarted, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.ScrollStarted, Callable.From(value));
		}
	}
	...
	public event Action ScrollEnded
	{
		add
		{
			Connect(SignalName.ScrollEnded, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.ScrollEnded, Callable.From(value));
		}
	}
