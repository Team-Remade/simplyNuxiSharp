...
public class VoxelGraphEditorNode
{
	// Engine object used for calling engine methods
	protected GraphNode _object;

	public VoxelGraphEditorNode() : this(NativeName)
	{
	}
	protected VoxelGraphEditorNode(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelGraphEditorNode(Variant variant) : this((GraphNode) variant)
	{
	}
	protected VoxelGraphEditorNode([NotNull] GraphNode @object)
	{
		_object = @object;
	}

	public static implicit operator GraphNode(VoxelGraphEditorNode self) => self?._object;
	public static implicit operator Variant(VoxelGraphEditorNode self) => self?._object;
	public static explicit operator VoxelGraphEditorNode(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : GraphNode.PropertyName
	{

	}

	public class MethodName : GraphNode.MethodName
	{

	}

	public class SignalName : GraphNode.SignalName
	{

	}

	private static readonly StringName NativeName = "VoxelGraphEditorNode";
	...
	{
		get => _object.IgnoreInvalidConnectionType;
		set => _object.IgnoreInvalidConnectionType = value;
	}

	public Control.FocusModeEnum SlotsFocusMode
	{
		get => _object.SlotsFocusMode;
		set => _object.SlotsFocusMode = value;
	}

	public Godot.Vector2 PositionOffset
	{
		get => _object.PositionOffset;
		set => _object.PositionOffset = value;
	}

	public bool Resizable
	{
		get => _object.Resizable;
		set => _object.Resizable = value;
	}

	public bool Draggable
	{
		get => _object.Draggable;
		set => _object.Draggable = value;
	}

	public bool Selectable
	{
		get => _object.Selectable;
		set => _object.Selectable = value;
	}

	public bool Selected
	{
		get => _object.Selected;
		set => _object.Selected = value;
	}

	public bool ScalingMenus
	{
		get => _object.ScalingMenus;
		set => _object.ScalingMenus = value;
	}
	...
	{
		return (Godot.HBoxContainer)_object.Call("get_titlebar_hbox");
	}

	public void SetSlot(int @slot_index, bool @enable_left_port, int @type_left, Godot.Color @color_left, bool @enable_right_port, int @type_right, Godot.Color @color_right, Texture2D @custom_icon_left = default, Texture2D @custom_icon_right = default, bool @draw_stylebox = true)
	{
		_object.SetSlot(@slot_index, @enable_left_port, @type_left, @color_left, @enable_right_port, @type_right, @color_right, @custom_icon_left, @custom_icon_right, @draw_stylebox);
	}

	public void ClearSlot(int @slot_index)
	{
		_object.ClearSlot(@slot_index);
	}

	public void ClearAllSlots()
	{
		_object.ClearAllSlots();
	}

	public bool IsSlotEnabledLeft(int @slot_index)
	{
		return _object.IsSlotEnabledLeft(@slot_index);
	}

	public void SetSlotEnabledLeft(int @slot_index, bool @enable)
	{
		_object.SetSlotEnabledLeft(@slot_index, @enable);
	}

	public void SetSlotTypeLeft(int @slot_index, int @type)
	{
		_object.SetSlotTypeLeft(@slot_index, @type);
	}

	public int GetSlotTypeLeft(int @slot_index)
	{
		return _object.GetSlotTypeLeft(@slot_index);
	}

	public void SetSlotColorLeft(int @slot_index, Godot.Color @color)
	{
		_object.SetSlotColorLeft(@slot_index, @color);
	}

	public Godot.Color GetSlotColorLeft(int @slot_index)
	{
		return _object.GetSlotColorLeft(@slot_index);
	}

	public void SetSlotCustomIconLeft(int @slot_index, Texture2D @custom_icon)
	{
		_object.SetSlotCustomIconLeft(@slot_index, @custom_icon);
	}

	public Texture2D GetSlotCustomIconLeft(int @slot_index)
	{
		return _object.GetSlotCustomIconLeft(@slot_index);
	}

	public void SetSlotMetadataLeft(int @slot_index, Variant @value)
	{
		_object.SetSlotMetadataLeft(@slot_index, @value);
	}

	public Variant GetSlotMetadataLeft(int @slot_index)
	{
		return _object.GetSlotMetadataLeft(@slot_index);
	}

	public bool IsSlotEnabledRight(int @slot_index)
	{
		return _object.IsSlotEnabledRight(@slot_index);
	}

	public void SetSlotEnabledRight(int @slot_index, bool @enable)
	{
		_object.SetSlotEnabledRight(@slot_index, @enable);
	}

	public void SetSlotTypeRight(int @slot_index, int @type)
	{
		_object.SetSlotTypeRight(@slot_index, @type);
	}

	public int GetSlotTypeRight(int @slot_index)
	{
		return _object.GetSlotTypeRight(@slot_index);
	}

	public void SetSlotColorRight(int @slot_index, Godot.Color @color)
	{
		_object.SetSlotColorRight(@slot_index, @color);
	}

	public Godot.Color GetSlotColorRight(int @slot_index)
	{
		return _object.GetSlotColorRight(@slot_index);
	}

	public void SetSlotCustomIconRight(int @slot_index, Texture2D @custom_icon)
	{
		_object.SetSlotCustomIconRight(@slot_index, @custom_icon);
	}

	public Texture2D GetSlotCustomIconRight(int @slot_index)
	{
		return _object.GetSlotCustomIconRight(@slot_index);
	}

	public void SetSlotMetadataRight(int @slot_index, Variant @value)
	{
		_object.SetSlotMetadataRight(@slot_index, @value);
	}

	public Variant GetSlotMetadataRight(int @slot_index)
	{
		return _object.GetSlotMetadataRight(@slot_index);
	}

	public bool IsSlotDrawStylebox(int @slot_index)
	{
		return _object.IsSlotDrawStylebox(@slot_index);
	}

	public void SetSlotDrawStylebox(int @slot_index, bool @enable)
	{
		_object.SetSlotDrawStylebox(@slot_index, @enable);
	}

	public void SetIgnoreInvalidConnectionType(bool @ignore)
	{
		_object.SetIgnoreInvalidConnectionType(@ignore);
	}

	public bool IsIgnoringValidConnectionType()
	{
		return _object.IsIgnoringValidConnectionType();
	}

	public void SetSlotsFocusMode(Control.FocusModeEnum @focus_mode)
	{
		_object.SetSlotsFocusMode(@focus_mode);
	}

	public Control.FocusModeEnum GetSlotsFocusMode()
	{
		return _object.GetSlotsFocusMode();
	}

	public int GetInputPortCount()
	{
		return _object.GetInputPortCount();
	}

	public Godot.Vector2 GetInputPortPosition(int @port_idx)
	{
		return _object.GetInputPortPosition(@port_idx);
	}

	public int GetInputPortType(int @port_idx)
	{
		return _object.GetInputPortType(@port_idx);
	}

	public Godot.Color GetInputPortColor(int @port_idx)
	{
		return _object.GetInputPortColor(@port_idx);
	}

	public int GetInputPortSlot(int @port_idx)
	{
		return _object.GetInputPortSlot(@port_idx);
	}

	public int GetOutputPortCount()
	{
		return _object.GetOutputPortCount();
	}

	public Godot.Vector2 GetOutputPortPosition(int @port_idx)
	{
		return _object.GetOutputPortPosition(@port_idx);
	}

	public int GetOutputPortType(int @port_idx)
	{
		return _object.GetOutputPortType(@port_idx);
	}

	public Godot.Color GetOutputPortColor(int @port_idx)
	{
		return _object.GetOutputPortColor(@port_idx);
	}

	public int GetOutputPortSlot(int @port_idx)
	{
		return _object.GetOutputPortSlot(@port_idx);
	}

	public void SetResizable(bool @resizable)
	{
		_object.SetResizable(@resizable);
	}

	public bool IsResizable()
	{
		return _object.IsResizable();
	}

	public void SetDraggable(bool @draggable)
	{
		_object.SetDraggable(@draggable);
	}

	public bool IsDraggable()
	{
		return _object.IsDraggable();
	}

	public void SetSelectable(bool @selectable)
	{
		_object.SetSelectable(@selectable);
	}

	public bool IsSelectable()
	{
		return _object.IsSelectable();
	}
	...
	public void SetScalingMenus(bool @scaling_menus)
	{
		_object.SetScalingMenus(@scaling_menus);
	}

	public bool IsScalingMenus()
	{
		return _object.IsScalingMenus();
	}

	public void SetPositionOffset(Godot.Vector2 @offset)
	{
		_object.SetPositionOffset(@offset);
	}

	public Godot.Vector2 GetPositionOffset()
	{
		return _object.GetPositionOffset();
	}
	...
	public event Action<int> SlotUpdated
	{
		add
		{
			Connect(SignalName.SlotUpdated, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.SlotUpdated, Callable.From(value));
		}
	}
	...
	public event Action SlotSizesChanged
	{
		add
		{
			Connect(SignalName.SlotSizesChanged, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.SlotSizesChanged, Callable.From(value));
		}
	}
	...
	public event Action NodeDeselected
	{
		add
		{
			Connect(SignalName.NodeDeselected, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.NodeDeselected, Callable.From(value));
		}
	}
	...
	public event Action RaiseRequest
	{
		add
		{
			Connect(SignalName.RaiseRequest, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.RaiseRequest, Callable.From(value));
		}
	}
	...
	public event Action DeleteRequest
	{
		add
		{
			Connect(SignalName.DeleteRequest, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.DeleteRequest, Callable.From(value));
		}
	}
	...
	public event Action<Godot.Vector2> ResizeRequest
	{
		add
		{
			Connect(SignalName.ResizeRequest, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.ResizeRequest, Callable.From(value));
		}
	}

	public event Action<Godot.Vector2> ResizeEnd
	{
		add
		{
			Connect(SignalName.ResizeEnd, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.ResizeEnd, Callable.From(value));
		}
	}
	...
	public event Action<Godot.Vector2, Godot.Vector2> Dragged
	{
		add
		{
			Connect(SignalName.Dragged, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.Dragged, Callable.From(value));
		}
	}
	...
	public event Action PositionOffsetChanged
	{
		add
		{
			Connect(SignalName.PositionOffsetChanged, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.PositionOffsetChanged, Callable.From(value));
		}
	}
