...
public class VoxelBlockyTypeLibraryIDSDialog
{
	// Engine object used for calling engine methods
	protected AcceptDialog _object;

	public VoxelBlockyTypeLibraryIDSDialog() : this(NativeName)
	{
	}
	protected VoxelBlockyTypeLibraryIDSDialog(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelBlockyTypeLibraryIDSDialog(Variant variant) : this((AcceptDialog) variant)
	{
	}
	protected VoxelBlockyTypeLibraryIDSDialog([NotNull] AcceptDialog @object)
	{
		_object = @object;
	}

	public static implicit operator AcceptDialog(VoxelBlockyTypeLibraryIDSDialog self) => self?._object;
	public static implicit operator Variant(VoxelBlockyTypeLibraryIDSDialog self) => self?._object;
	public static explicit operator VoxelBlockyTypeLibraryIDSDialog(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelBlockyTypeLibraryIDSDialog";
