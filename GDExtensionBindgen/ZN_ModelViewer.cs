...
public class ZN_ModelViewer
{
	// Engine object used for calling engine methods
	protected Control _object;

	public ZN_ModelViewer() : this(NativeName)
	{
	}
	protected ZN_ModelViewer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ZN_ModelViewer(Variant variant) : this((Control) variant)
	{
	}
	protected ZN_ModelViewer([NotNull] Control @object)
	{
		_object = @object;
	}

	public static implicit operator Control(ZN_ModelViewer self) => self?._object;
	public static implicit operator Variant(ZN_ModelViewer self) => self?._object;
	public static explicit operator ZN_ModelViewer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "ZN_ModelViewer";
