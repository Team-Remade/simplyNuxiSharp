...
public class VoxelEngineUpdater
{
	// Engine object used for calling engine methods
	protected Node _object;

	public VoxelEngineUpdater() : this(NativeName)
	{
	}
	protected VoxelEngineUpdater(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelEngineUpdater(Variant variant) : this((Node) variant)
	{
	}
	protected VoxelEngineUpdater([NotNull] Node @object)
	{
		_object = @object;
	}

	public static implicit operator Node(VoxelEngineUpdater self) => self?._object;
	public static implicit operator Variant(VoxelEngineUpdater self) => self?._object;
	public static explicit operator VoxelEngineUpdater(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelEngineUpdater";
