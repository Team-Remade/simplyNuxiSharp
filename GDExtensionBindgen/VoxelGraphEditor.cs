...
public class VoxelGraphEditor
{
	...
	public VoxelGraphEditor() : this(NativeName)
	{
	}
	protected VoxelGraphEditor(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelGraphEditor(Variant variant) : this((Control) variant)
	{
	}
	protected VoxelGraphEditor([NotNull] Control @object)
	{
		_object = @object;
	}

	public static implicit operator Control(VoxelGraphEditor self) => self?._object;
	public static implicit operator Variant(VoxelGraphEditor self) => self?._object;
	public static explicit operator VoxelGraphEditor(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	{
		public static readonly StringName CreateNodeGui = "create_node_gui";
		public static readonly StringName CreateNodeGuiInputConnections = "create_node_gui_input_connections";
		public static readonly StringName RemoveNodeGui = "remove_node_gui";
		public static readonly StringName SetNodePosition = "set_node_position";
		public static readonly StringName SetNodeSize = "set_node_size";
		public static readonly StringName UpdateNodeLayout = "update_node_layout";
		public static readonly StringName UpdateNodeComment = "update_node_comment";
	}
	...
	public class SignalName : Control.SignalName
	{
		...
		public static readonly StringName NodesDeleted = "nodes_deleted";
		public static readonly StringName RegenerateRequested = "regenerate_requested";
		public static readonly StringName PopoutRequested = "popout_requested";
	}

	private static readonly StringName NativeName = "VoxelGraphEditor";
	...
	public void CreateNodeGui(int @node_id)
	{
		_object.Call(MethodName.CreateNodeGui, @node_id);
	}

	public void CreateNodeGuiInputConnections(int @node_id)
	{
		_object.Call(MethodName.CreateNodeGuiInputConnections, @node_id);
	}

	public void RemoveNodeGui(Godot.StringName @node_name)
	{
		_object.Call(MethodName.RemoveNodeGui, @node_name);
	}

	public void SetNodePosition(int @node_id, Godot.Vector2 @offset)
	{
		_object.Call(MethodName.SetNodePosition, @node_id, @offset);
	}

	public void SetNodeSize(int @node_id, Godot.Vector2 @size)
	{
		_object.Call(MethodName.SetNodeSize, @node_id, @size);
	}

	public void UpdateNodeLayout(int @node_id)
	{
		_object.Call(MethodName.UpdateNodeLayout, @node_id);
	}

	public void UpdateNodeComment(int @node_id)
	{
		_object.Call(MethodName.UpdateNodeComment, @node_id);
	}
	...
	public event Action NothingSelected
	{
		add
		{
			Connect(SignalName.NothingSelected, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.NothingSelected, Callable.From(value));
		}
	}
	...
	public event Action NodesDeleted
	{
		add
		{
			Connect(SignalName.NodesDeleted, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.NodesDeleted, Callable.From(value));
		}
	}
	...
	public event Action RegenerateRequested
	{
		add
		{
			Connect(SignalName.RegenerateRequested, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.RegenerateRequested, Callable.From(value));
		}
	}
	...
	public event Action PopoutRequested
	{
		add
		{
			Connect(SignalName.PopoutRequested, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.PopoutRequested, Callable.From(value));
		}
	}
