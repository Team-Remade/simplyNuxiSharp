...
public class ZN_ControlSizer
{
	// Engine object used for calling engine methods
	protected Control _object;

	public ZN_ControlSizer() : this(NativeName)
	{
	}
	protected ZN_ControlSizer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ZN_ControlSizer(Variant variant) : this((Control) variant)
	{
	}
	protected ZN_ControlSizer([NotNull] Control @object)
	{
		_object = @object;
	}

	public static implicit operator Control(ZN_ControlSizer self) => self?._object;
	public static implicit operator Variant(ZN_ControlSizer self) => self?._object;
	public static explicit operator ZN_ControlSizer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "ZN_ControlSizer";
