...
public class VoxelRangeAnalysisDialog
{
	// Engine object used for calling engine methods
	protected AcceptDialog _object;

	public VoxelRangeAnalysisDialog() : this(NativeName)
	{
	}
	protected VoxelRangeAnalysisDialog(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelRangeAnalysisDialog(Variant variant) : this((AcceptDialog) variant)
	{
	}
	protected VoxelRangeAnalysisDialog([NotNull] AcceptDialog @object)
	{
		_object = @object;
	}

	public static implicit operator AcceptDialog(VoxelRangeAnalysisDialog self) => self?._object;
	public static implicit operator Variant(VoxelRangeAnalysisDialog self) => self?._object;
	public static explicit operator VoxelRangeAnalysisDialog(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : AcceptDialog.PropertyName
	{

	}

	public class MethodName : AcceptDialog.MethodName
	{

	}

	public class SignalName : AcceptDialog.SignalName
	{
		public static readonly StringName AnalysisToggled = "analysis_toggled";
		public static readonly StringName AreaChanged = "area_changed";
	}

	private static readonly StringName NativeName = "VoxelRangeAnalysisDialog";
	...
	public event Action<bool> AnalysisToggled
	{
		add
		{
			Connect(SignalName.AnalysisToggled, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.AnalysisToggled, Callable.From(value));
		}
	}
	...
	public event Action AreaChanged
	{
		add
		{
			Connect(SignalName.AreaChanged, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.AreaChanged, Callable.From(value));
		}
	}
