...
public class VoxelAboutWindow
{
	// Engine object used for calling engine methods
	protected AcceptDialog _object;

	public VoxelAboutWindow() : this(NativeName)
	{
	}
	protected VoxelAboutWindow(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelAboutWindow(Variant variant) : this((AcceptDialog) variant)
	{
	}
	protected VoxelAboutWindow([NotNull] AcceptDialog @object)
	{
		_object = @object;
	}

	public static implicit operator AcceptDialog(VoxelAboutWindow self) => self?._object;
	public static implicit operator Variant(VoxelAboutWindow self) => self?._object;
	public static explicit operator VoxelAboutWindow(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelAboutWindow";
