...
public class VoxelRaycastResult
{
	...
	public VoxelRaycastResult() : this(NativeName)
	{
	}
	protected VoxelRaycastResult(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelRaycastResult(Variant variant) : this((RefCounted) variant)
	{
	}
	protected VoxelRaycastResult([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(VoxelRaycastResult self) => self?._object;
	public static implicit operator Variant(VoxelRaycastResult self) => self?._object;
	public static explicit operator VoxelRaycastResult(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : RefCounted.PropertyName
	{
		public static readonly StringName Position = "position";
		public static readonly StringName PreviousPosition = "previous_position";
	...
	public class MethodName : RefCounted.MethodName
	{
		...
		public static readonly StringName GetPreviousPosition = "get_previous_position";
	...
	private static readonly StringName NativeName = "VoxelRaycastResult";

	#region Properties

	public Godot.Vector3I Position
	{
		get => (Godot.Vector3I)_object.Get(PropertyName.Position);
	}

	public Godot.Vector3I PreviousPosition
	{
		get => (Godot.Vector3I)_object.Get(PropertyName.PreviousPosition);
	}
	...
	{
		get => (Godot.Vector3)_object.Get(PropertyName.Normal);
	}
	...
	public Godot.Vector3I GetPreviousPosition()
	{
		return (Godot.Vector3I)_object.Call(MethodName.GetPreviousPosition);
	}
	...
	public Godot.Vector3 GetNormal()
	{
		return (Godot.Vector3)_object.Call(MethodName.GetNormal);
	}
