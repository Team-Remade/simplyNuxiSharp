...
public class VoxelGraphEditorShaderDialog
{
	// Engine object used for calling engine methods
	protected AcceptDialog _object;

	public VoxelGraphEditorShaderDialog() : this(NativeName)
	{
	}
	protected VoxelGraphEditorShaderDialog(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelGraphEditorShaderDialog(Variant variant) : this((AcceptDialog) variant)
	{
	}
	protected VoxelGraphEditorShaderDialog([NotNull] AcceptDialog @object)
	{
		_object = @object;
	}

	public static implicit operator AcceptDialog(VoxelGraphEditorShaderDialog self) => self?._object;
	public static implicit operator Variant(VoxelGraphEditorShaderDialog self) => self?._object;
	public static explicit operator VoxelGraphEditorShaderDialog(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelGraphEditorShaderDialog";
