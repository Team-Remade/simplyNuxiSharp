...
public class VoxelBlockyLibraryEditorPlugin
{
	// Engine object used for calling engine methods
	protected EditorPlugin _object;

	public VoxelBlockyLibraryEditorPlugin() : this(NativeName)
	{
	}
	protected VoxelBlockyLibraryEditorPlugin(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelBlockyLibraryEditorPlugin(Variant variant) : this((EditorPlugin) variant)
	{
	}
	protected VoxelBlockyLibraryEditorPlugin([NotNull] EditorPlugin @object)
	{
		_object = @object;
	}

	public static implicit operator EditorPlugin(VoxelBlockyLibraryEditorPlugin self) => self?._object;
	public static implicit operator Variant(VoxelBlockyLibraryEditorPlugin self) => self?._object;
	public static explicit operator VoxelBlockyLibraryEditorPlugin(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelBlockyLibraryEditorPlugin";
	...
	{
		_object.AddControlToDock(@slot, @control, @shortcut);
	}
	...
	{
		_object.AddContextMenuPlugin(@slot, @plugin);
	}
	...
	public event Action<Node> SceneChanged
	{
		add
		{
	...
	public event Action<string> SceneClosed
	{
		add
		{
	...
	public event Action<string> MainScreenChanged
	{
		add
		{
	...
	public event Action<Resource> ResourceSaved
	{
		add
		{
