...
public class VoxelSaveCompletionTracker
{
	// Engine object used for calling engine methods
	protected RefCounted _object;

	public VoxelSaveCompletionTracker() : this(NativeName)
	{
	}
	protected VoxelSaveCompletionTracker(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelSaveCompletionTracker(Variant variant) : this((RefCounted) variant)
	{
	}
	protected VoxelSaveCompletionTracker([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(VoxelSaveCompletionTracker self) => self?._object;
	public static implicit operator Variant(VoxelSaveCompletionTracker self) => self?._object;
	public static explicit operator VoxelSaveCompletionTracker(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	{
		public static readonly StringName IsComplete = "is_complete";
		public static readonly StringName IsAborted = "is_aborted";
		public static readonly StringName GetTotalTasks = "get_total_tasks";
		public static readonly StringName GetRemainingTasks = "get_remaining_tasks";
	}
	...
	private static readonly StringName NativeName = "VoxelSaveCompletionTracker";

	#region Methods

	public bool IsComplete()
	{
		return (bool)_object.Call(MethodName.IsComplete);
	}

	public bool IsAborted()
	{
		return (bool)_object.Call(MethodName.IsAborted);
	}

	public int GetTotalTasks()
	{
		return (int)_object.Call(MethodName.GetTotalTasks);
	}

	public int GetRemainingTasks()
	{
		return (int)_object.Call(MethodName.GetRemainingTasks);
	}
