...
public class VoxelVoxEditorPlugin
{
	// Engine object used for calling engine methods
	protected EditorPlugin _object;

	public VoxelVoxEditorPlugin() : this(NativeName)
	{
	}
	protected VoxelVoxEditorPlugin(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelVoxEditorPlugin(Variant variant) : this((EditorPlugin) variant)
	{
	}
	protected VoxelVoxEditorPlugin([NotNull] EditorPlugin @object)
	{
		_object = @object;
	}

	public static implicit operator EditorPlugin(VoxelVoxEditorPlugin self) => self?._object;
	public static implicit operator Variant(VoxelVoxEditorPlugin self) => self?._object;
	public static explicit operator VoxelVoxEditorPlugin(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelVoxEditorPlugin";
