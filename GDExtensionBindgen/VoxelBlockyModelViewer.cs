...
public class VoxelBlockyModelViewer
{
	// Engine object used for calling engine methods
	protected HBoxContainer _object;

	public VoxelBlockyModelViewer() : this(NativeName)
	{
	}
	protected VoxelBlockyModelViewer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelBlockyModelViewer(Variant variant) : this((HBoxContainer) variant)
	{
	}
	protected VoxelBlockyModelViewer([NotNull] HBoxContainer @object)
	{
		_object = @object;
	}

	public static implicit operator HBoxContainer(VoxelBlockyModelViewer self) => self?._object;
	public static implicit operator Variant(VoxelBlockyModelViewer self) => self?._object;
	public static explicit operator VoxelBlockyModelViewer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	{
		public static readonly StringName AddRotationAnim = "add_rotation_anim";
	}
	...
	private static readonly StringName NativeName = "VoxelBlockyModelViewer";
	...
	public void AddRotationAnim(Godot.Basis @_unnamed_arg0)
	{
		_object.Call(MethodName.AddRotationAnim, @_unnamed_arg0);
	}
