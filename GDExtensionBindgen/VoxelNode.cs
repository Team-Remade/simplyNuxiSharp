...
public class VoxelNode
{
	...
	public VoxelNode() : this(NativeName)
	{
	}
	protected VoxelNode(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelNode(Variant variant) : this((Node3D) variant)
	{
	}
	protected VoxelNode([NotNull] Node3D @object)
	{
		_object = @object;
	}

	public static implicit operator Node3D(VoxelNode self) => self?._object;
	public static implicit operator Variant(VoxelNode self) => self?._object;
	public static explicit operator VoxelNode(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : Node3D.PropertyName
	{
		public static readonly StringName Stream = "stream";
		public static readonly StringName Generator = "generator";
		public static readonly StringName Mesher = "mesher";
		...
		public static readonly StringName RenderLayersMask = "render_layers_mask";
	}
	...
	public class MethodName : Node3D.MethodName
	{
		...
		public static readonly StringName SetGenerator = "set_generator";
		public static readonly StringName GetGenerator = "get_generator";
		public static readonly StringName SetMesher = "set_mesher";
		public static readonly StringName GetMesher = "get_mesher";
		...
		public static readonly StringName SetShadowCasting = "set_shadow_casting";
		public static readonly StringName GetShadowCasting = "get_shadow_casting";
		public static readonly StringName SetRenderLayersMask = "set_render_layers_mask";
		public static readonly StringName GetRenderLayersMask = "get_render_layers_mask";
		public static readonly StringName ConvertToNodes = "convert_to_nodes";
	}
	...
	private static readonly StringName NativeName = "VoxelNode";

	#region Enums

	[Flags]
	public enum NodeConversionFlags : long
	{
		Instancer = 1L,
		InvisibleBlocks = 2L,
		MaterialOverrides = 4L,
	}
	...
	public VoxelStream Stream
	{
		get => (VoxelStream)_object.Get(PropertyName.Stream);
		set => _object.Set(PropertyName.Stream, value);
	}

	public VoxelGenerator Generator
	{
		get => (VoxelGenerator)_object.Get(PropertyName.Generator);
		set => _object.Set(PropertyName.Generator, value);
	}

	public VoxelMesher Mesher
	{
		get => (VoxelMesher)_object.Get(PropertyName.Mesher);
		set => _object.Set(PropertyName.Mesher, value);
	}

	public VoxelFormat Format
	{
		get => (VoxelFormat)_object.Get(PropertyName.Format);
	...
	public int RenderLayersMask
	{
		get => (int)_object.Get(PropertyName.RenderLayersMask);
		set => _object.Set(PropertyName.RenderLayersMask, value);
	}
	...
	public void SetStream(VoxelStream @stream)
	{
		_object.Call(MethodName.SetStream, @stream);
	}

	public VoxelStream GetStream()
	{
		return (VoxelStream)_object.Call(MethodName.GetStream);
	}

	public void SetGenerator(VoxelGenerator @generator)
	{
		_object.Call(MethodName.SetGenerator, @generator);
	}

	public VoxelGenerator GetGenerator()
	{
		return (VoxelGenerator)_object.Call(MethodName.GetGenerator);
	}

	public void SetMesher(VoxelMesher @mesher)
	{
		_object.Call(MethodName.SetMesher, @mesher);
	}

	public VoxelMesher GetMesher()
	{
		return (VoxelMesher)_object.Call(MethodName.GetMesher);
	}

	public void SetFormat(VoxelFormat @format)
	{
		_object.Call(MethodName.SetFormat, @format);
	}

	public VoxelFormat GetFormat()
	{
		return (VoxelFormat)_object.Call(MethodName.GetFormat);
	}
	...
	public void SetShadowCasting(GeometryInstance3D.ShadowCastingSetting @mode)
	{
		_object.Call(MethodName.SetShadowCasting, (int)@mode);
	}

	public GeometryInstance3D.ShadowCastingSetting GetShadowCasting()
	{
		return (GeometryInstance3D.ShadowCastingSetting)(int)_object.Call(MethodName.GetShadowCasting);
	}

	public void SetRenderLayersMask(int @mask)
	{
		_object.Call(MethodName.SetRenderLayersMask, @mask);
	}

	public int GetRenderLayersMask()
	{
		return (int)_object.Call(MethodName.GetRenderLayersMask);
	}

	public Node3D ConvertToNodes(VoxelNode.NodeConversionFlags @flags)
	{
		return (Node3D)_object.Call(MethodName.ConvertToNodes, (int)@flags);
	}
