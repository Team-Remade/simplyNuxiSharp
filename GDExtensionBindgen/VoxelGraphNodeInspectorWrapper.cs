...
public class VoxelGraphNodeInspectorWrapper
{
	// Engine object used for calling engine methods
	protected RefCounted _object;

	public VoxelGraphNodeInspectorWrapper() : this(NativeName)
	{
	}
	protected VoxelGraphNodeInspectorWrapper(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelGraphNodeInspectorWrapper(Variant variant) : this((RefCounted) variant)
	{
	}
	protected VoxelGraphNodeInspectorWrapper([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(VoxelGraphNodeInspectorWrapper self) => self?._object;
	public static implicit operator Variant(VoxelGraphNodeInspectorWrapper self) => self?._object;
	public static explicit operator VoxelGraphNodeInspectorWrapper(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelGraphNodeInspectorWrapper";
