...
public class VoxelBlockyTypeVariantListEditor
{
	// Engine object used for calling engine methods
	protected VBoxContainer _object;

	public VoxelBlockyTypeVariantListEditor() : this(NativeName)
	{
	}
	protected VoxelBlockyTypeVariantListEditor(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelBlockyTypeVariantListEditor(Variant variant) : this((VBoxContainer) variant)
	{
	}
	protected VoxelBlockyTypeVariantListEditor([NotNull] VBoxContainer @object)
	{
		_object = @object;
	}

	public static implicit operator VBoxContainer(VoxelBlockyTypeVariantListEditor self) => self?._object;
	public static implicit operator Variant(VoxelBlockyTypeVariantListEditor self) => self?._object;
	public static explicit operator VoxelBlockyTypeVariantListEditor(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelBlockyTypeVariantListEditor";
