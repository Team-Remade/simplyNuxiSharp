...
public class ZN_EditorImportPlugin
{
	// Engine object used for calling engine methods
	protected EditorImportPlugin _object;

	public ZN_EditorImportPlugin() : this(NativeName)
	{
	}
	protected ZN_EditorImportPlugin(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ZN_EditorImportPlugin(Variant variant) : this((EditorImportPlugin) variant)
	{
	}
	protected ZN_EditorImportPlugin([NotNull] EditorImportPlugin @object)
	{
		_object = @object;
	}

	public static implicit operator EditorImportPlugin(ZN_EditorImportPlugin self) => self?._object;
	public static implicit operator Variant(ZN_EditorImportPlugin self) => self?._object;
	public static explicit operator ZN_EditorImportPlugin(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "ZN_EditorImportPlugin";
