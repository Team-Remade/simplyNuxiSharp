...
public class VoxelBlockSerializer
{
	// Engine object used for calling engine methods
	protected RefCounted _object;

	public VoxelBlockSerializer() : this(NativeName)
	{
	}
	protected VoxelBlockSerializer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelBlockSerializer(Variant variant) : this((RefCounted) variant)
	{
	}
	protected VoxelBlockSerializer([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(VoxelBlockSerializer self) => self?._object;
	public static implicit operator Variant(VoxelBlockSerializer self) => self?._object;
	public static explicit operator VoxelBlockSerializer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	{
		public static readonly StringName SerializeToStreamPeer = "serialize_to_stream_peer";
		public static readonly StringName DeserializeFromStreamPeer = "deserialize_from_stream_peer";
		public static readonly StringName SerializeToByteArray = "serialize_to_byte_array";
		public static readonly StringName DeserializeFromByteArray = "deserialize_from_byte_array";
	}
	...
	private static readonly StringName NativeName = "VoxelBlockSerializer";
	...
	public static int SerializeToStreamPeer(StreamPeer @peer, VoxelBuffer @voxel_buffer, VoxelBlockSerializer.Compression @compress)
	{
		return (int)ClassDB.ClassCallStatic(NativeName, MethodName.SerializeToStreamPeer, @peer, @voxel_buffer, (int)@compress);
	}

	public static void DeserializeFromStreamPeer(StreamPeer @peer, VoxelBuffer @voxel_buffer, int @size, bool @decompress)
	{
		ClassDB.ClassCallStatic(NativeName, MethodName.DeserializeFromStreamPeer, @peer, @voxel_buffer, @size, @decompress);
	}

	public static byte[] SerializeToByteArray(VoxelBuffer @voxel_buffer, VoxelBlockSerializer.Compression @compress)
	{
		return (byte[])ClassDB.ClassCallStatic(NativeName, MethodName.SerializeToByteArray, @voxel_buffer, (int)@compress);
	}

	public static void DeserializeFromByteArray(byte[] @bytes, VoxelBuffer @voxel_buffer, bool @decompress)
	{
		ClassDB.ClassCallStatic(NativeName, MethodName.DeserializeFromByteArray, @bytes, @voxel_buffer, @decompress);
	}
