...
public class VoxelBlockyLibraryBase
{
	// Engine object used for calling engine methods
	protected Resource _object;

	public VoxelBlockyLibraryBase() : this(NativeName)
	{
	}
	protected VoxelBlockyLibraryBase(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelBlockyLibraryBase(Variant variant) : this((Resource) variant)
	{
	}
	protected VoxelBlockyLibraryBase([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(VoxelBlockyLibraryBase self) => self?._object;
	public static implicit operator Variant(VoxelBlockyLibraryBase self) => self?._object;
	public static explicit operator VoxelBlockyLibraryBase(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : Resource.PropertyName
	{
		public static readonly StringName BakeTangents = "bake_tangents";
	}

	public class MethodName : Resource.MethodName
	{
		public static readonly StringName GetMaterials = "get_materials";
		public static readonly StringName GetBakeTangents = "get_bake_tangents";
		public static readonly StringName SetBakeTangents = "set_bake_tangents";
	...
	private static readonly StringName NativeName = "VoxelBlockyLibraryBase";

	#region Integer Constants

	public const long MaxModels = 65536L;

	public const long MaxMaterials = 65536L;

	#endregion

	#region Properties

	public bool BakeTangents
	{
		get => (bool)_object.Get(PropertyName.BakeTangents);
		set => _object.Set(PropertyName.BakeTangents, value);
	}
	...
	public Godot.Collections.Array<Godot.Material> GetMaterials()
	{
		return (Godot.Collections.Array<Godot.Material>)_object.Call(MethodName.GetMaterials);
	}

	public bool GetBakeTangents()
	{
		return (bool)_object.Call(MethodName.GetBakeTangents);
	}

	public void SetBakeTangents(bool @bake_tangents)
	{
		_object.Call(MethodName.SetBakeTangents, @bake_tangents);
	}
