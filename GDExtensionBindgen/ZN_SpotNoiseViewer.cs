...
public class ZN_SpotNoiseViewer
{
	// Engine object used for calling engine methods
	protected Control _object;

	public ZN_SpotNoiseViewer() : this(NativeName)
	{
	}
	protected ZN_SpotNoiseViewer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ZN_SpotNoiseViewer(Variant variant) : this((Control) variant)
	{
	}
	protected ZN_SpotNoiseViewer([NotNull] Control @object)
	{
		_object = @object;
	}

	public static implicit operator Control(ZN_SpotNoiseViewer self) => self?._object;
	public static implicit operator Variant(ZN_SpotNoiseViewer self) => self?._object;
	public static explicit operator ZN_SpotNoiseViewer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "ZN_SpotNoiseViewer";
