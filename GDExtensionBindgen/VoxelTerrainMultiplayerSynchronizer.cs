...
public class VoxelTerrainMultiplayerSynchronizer
{
	// Engine object used for calling engine methods
	protected Node _object;

	public VoxelTerrainMultiplayerSynchronizer() : this(NativeName)
	{
	}
	protected VoxelTerrainMultiplayerSynchronizer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelTerrainMultiplayerSynchronizer(Variant variant) : this((Node) variant)
	{
	}
	protected VoxelTerrainMultiplayerSynchronizer([NotNull] Node @object)
	{
		_object = @object;
	}

	public static implicit operator Node(VoxelTerrainMultiplayerSynchronizer self) => self?._object;
	public static implicit operator Variant(VoxelTerrainMultiplayerSynchronizer self) => self?._object;
	public static explicit operator VoxelTerrainMultiplayerSynchronizer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelTerrainMultiplayerSynchronizer";
