...
public class VoxelViewer
{
	...
	public VoxelViewer() : this(NativeName)
	{
	}
	protected VoxelViewer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelViewer(Variant variant) : this((Node3D) variant)
	{
	}
	protected VoxelViewer([NotNull] Node3D @object)
	{
		_object = @object;
	}

	public static implicit operator Node3D(VoxelViewer self) => self?._object;
	public static implicit operator Variant(VoxelViewer self) => self?._object;
	public static explicit operator VoxelViewer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : Node3D.PropertyName
	{
		public static readonly StringName ViewDistance = "view_distance";
		public static readonly StringName ViewDistanceVerticalRatio = "view_distance_vertical_ratio";
		public static readonly StringName RequiresVisuals = "requires_visuals";
		public static readonly StringName RequiresCollisions = "requires_collisions";
		public static readonly StringName RequiresDataBlockNotifications = "requires_data_block_notifications";
		public static readonly StringName EnabledInEditor = "enabled_in_editor";
	}
	...
	public class MethodName : Node3D.MethodName
	{
		...
		public static readonly StringName SetViewDistanceVerticalRatio = "set_view_distance_vertical_ratio";
		public static readonly StringName GetViewDistanceVerticalRatio = "get_view_distance_vertical_ratio";
		public static readonly StringName SetRequiresVisuals = "set_requires_visuals";
		public static readonly StringName IsRequiringVisuals = "is_requiring_visuals";
		public static readonly StringName SetRequiresCollisions = "set_requires_collisions";
		public static readonly StringName IsRequiringCollisions = "is_requiring_collisions";
		public static readonly StringName SetRequiresDataBlockNotifications = "set_requires_data_block_notifications";
		public static readonly StringName IsRequiringDataBlockNotifications = "is_requiring_data_block_notifications";
		public static readonly StringName SetNetworkPeerId = "set_network_peer_id";
		public static readonly StringName GetNetworkPeerId = "get_network_peer_id";
		public static readonly StringName SetEnabledInEditor = "set_enabled_in_editor";
		public static readonly StringName IsEnabledInEditor = "is_enabled_in_editor";
	}
	...
	private static readonly StringName NativeName = "VoxelViewer";
	...
	public float ViewDistanceVerticalRatio
	{
		get => (float)_object.Get(PropertyName.ViewDistanceVerticalRatio);
		set => _object.Set(PropertyName.ViewDistanceVerticalRatio, value);
	}

	public bool RequiresVisuals
	{
		get => (bool)_object.Get(PropertyName.RequiresVisuals);
		set => _object.Set(PropertyName.RequiresVisuals, value);
	}

	public bool RequiresCollisions
	{
		get => (bool)_object.Get(PropertyName.RequiresCollisions);
		set => _object.Set(PropertyName.RequiresCollisions, value);
	}

	public bool RequiresDataBlockNotifications
	{
		get => (bool)_object.Get(PropertyName.RequiresDataBlockNotifications);
		set => _object.Set(PropertyName.RequiresDataBlockNotifications, value);
	}

	public bool EnabledInEditor
	{
		get => (bool)_object.Get(PropertyName.EnabledInEditor);
		set => _object.Set(PropertyName.EnabledInEditor, value);
	}
	...
	{
		_object.Call(MethodName.SetViewDistance, @distance);
	}
	...
	public void SetViewDistanceVerticalRatio(float @ratio)
	{
		_object.Call(MethodName.SetViewDistanceVerticalRatio, @ratio);
	}

	public float GetViewDistanceVerticalRatio()
	{
		return (float)_object.Call(MethodName.GetViewDistanceVerticalRatio);
	}

	public void SetRequiresVisuals(bool @enabled)
	{
		_object.Call(MethodName.SetRequiresVisuals, @enabled);
	}

	public bool IsRequiringVisuals()
	{
		return (bool)_object.Call(MethodName.IsRequiringVisuals);
	}

	public void SetRequiresCollisions(bool @enabled)
	{
		_object.Call(MethodName.SetRequiresCollisions, @enabled);
	}

	public bool IsRequiringCollisions()
	{
		return (bool)_object.Call(MethodName.IsRequiringCollisions);
	}

	public void SetRequiresDataBlockNotifications(bool @enabled)
	{
		_object.Call(MethodName.SetRequiresDataBlockNotifications, @enabled);
	}

	public bool IsRequiringDataBlockNotifications()
	{
		return (bool)_object.Call(MethodName.IsRequiringDataBlockNotifications);
	}

	public void SetNetworkPeerId(int @id)
	{
		_object.Call(MethodName.SetNetworkPeerId, @id);
	}

	public int GetNetworkPeerId()
	{
		return (int)_object.Call(MethodName.GetNetworkPeerId);
	}

	public void SetEnabledInEditor(bool @enabled)
	{
		_object.Call(MethodName.SetEnabledInEditor, @enabled);
	}

	public bool IsEnabledInEditor()
	{
		return (bool)_object.Call(MethodName.IsEnabledInEditor);
	}
