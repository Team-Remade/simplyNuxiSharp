...
public class ZN_Axes3DControl
{
	// Engine object used for calling engine methods
	protected Control _object;

	public ZN_Axes3DControl() : this(NativeName)
	{
	}
	protected ZN_Axes3DControl(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ZN_Axes3DControl(Variant variant) : this((Control) variant)
	{
	}
	protected ZN_Axes3DControl([NotNull] Control @object)
	{
		_object = @object;
	}

	public static implicit operator Control(ZN_Axes3DControl self) => self?._object;
	public static implicit operator Variant(ZN_Axes3DControl self) => self?._object;
	public static explicit operator ZN_Axes3DControl(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "ZN_Axes3DControl";
