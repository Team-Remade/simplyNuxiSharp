...
public class VoxelBlockyTypeAttributeCombinationSelector
{
	// Engine object used for calling engine methods
	protected GridContainer _object;

	public VoxelBlockyTypeAttributeCombinationSelector() : this(NativeName)
	{
	}
	protected VoxelBlockyTypeAttributeCombinationSelector(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelBlockyTypeAttributeCombinationSelector(Variant variant) : this((GridContainer) variant)
	{
	}
	protected VoxelBlockyTypeAttributeCombinationSelector([NotNull] GridContainer @object)
	{
		_object = @object;
	}

	public static implicit operator GridContainer(VoxelBlockyTypeAttributeCombinationSelector self) => self?._object;
	public static implicit operator Variant(VoxelBlockyTypeAttributeCombinationSelector self) => self?._object;
	public static explicit operator VoxelBlockyTypeAttributeCombinationSelector(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : GridContainer.PropertyName
	{

	}

	public class MethodName : GridContainer.MethodName
	{

	}

	public class SignalName : GridContainer.SignalName
	{
		public static readonly StringName CombinationChanged = "combination_changed";
	}

	private static readonly StringName NativeName = "VoxelBlockyTypeAttributeCombinationSelector";
	...
	{
		_object.SetColumns(@columns);
	}

	public int GetColumns()
	{
		return _object.GetColumns();
	}
	...
	public event Action CombinationChanged
	{
		add
		{
			Connect(SignalName.CombinationChanged, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.CombinationChanged, Callable.From(value));
		}
	}
