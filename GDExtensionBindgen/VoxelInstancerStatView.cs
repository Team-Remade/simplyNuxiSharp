...
public class VoxelInstancerStatView
{
	// Engine object used for calling engine methods
	protected VBoxContainer _object;

	public VoxelInstancerStatView() : this(NativeName)
	{
	}
	protected VoxelInstancerStatView(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelInstancerStatView(Variant variant) : this((VBoxContainer) variant)
	{
	}
	protected VoxelInstancerStatView([NotNull] VBoxContainer @object)
	{
		_object = @object;
	}

	public static implicit operator VBoxContainer(VoxelInstancerStatView self) => self?._object;
	public static implicit operator Variant(VoxelInstancerStatView self) => self?._object;
	public static explicit operator VoxelInstancerStatView(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelInstancerStatView";
