...
public class VoxelModifier
{
	...
	public VoxelModifier() : this(NativeName)
	{
	}
	protected VoxelModifier(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelModifier(Variant variant) : this((Node3D) variant)
	{
	}
	protected VoxelModifier([NotNull] Node3D @object)
	{
		_object = @object;
	}

	public static implicit operator Node3D(VoxelModifier self) => self?._object;
	public static implicit operator Variant(VoxelModifier self) => self?._object;
	public static explicit operator VoxelModifier(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : Node3D.PropertyName
	{
		public static readonly StringName Operation = "operation";
		public static readonly StringName Smoothness = "smoothness";
	}
	...
	public class MethodName : Node3D.MethodName
	{
		...
		public static readonly StringName SetSmoothness = "set_smoothness";
		public static readonly StringName GetSmoothness = "get_smoothness";
	}
	...
	private static readonly StringName NativeName = "VoxelModifier";
	...
	{
		get => (int)_object.Get(PropertyName.Operation);
		set => _object.Set(PropertyName.Operation, value);
	}

	public float Smoothness
	{
		get => (float)_object.Get(PropertyName.Smoothness);
		set => _object.Set(PropertyName.Smoothness, value);
	}
	...
	public void SetOperation(VoxelModifier.OperationEnum @op)
	{
		_object.Call(MethodName.SetOperation, (int)@op);
	}

	public VoxelModifier.OperationEnum GetOperation()
	{
		return (VoxelModifier.OperationEnum)(int)_object.Call(MethodName.GetOperation);
	}

	public void SetSmoothness(float @smoothness)
	{
		_object.Call(MethodName.SetSmoothness, @smoothness);
	}

	public float GetSmoothness()
	{
		return (float)_object.Call(MethodName.GetSmoothness);
	}
