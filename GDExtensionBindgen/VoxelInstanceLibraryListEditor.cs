...
public class VoxelInstanceLibraryListEditor
{
	// Engine object used for calling engine methods
	protected HBoxContainer _object;

	public VoxelInstanceLibraryListEditor() : this(NativeName)
	{
	}
	protected VoxelInstanceLibraryListEditor(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelInstanceLibraryListEditor(Variant variant) : this((HBoxContainer) variant)
	{
	}
	protected VoxelInstanceLibraryListEditor([NotNull] HBoxContainer @object)
	{
		_object = @object;
	}

	public static implicit operator HBoxContainer(VoxelInstanceLibraryListEditor self) => self?._object;
	public static implicit operator Variant(VoxelInstanceLibraryListEditor self) => self?._object;
	public static explicit operator VoxelInstanceLibraryListEditor(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelInstanceLibraryListEditor";
