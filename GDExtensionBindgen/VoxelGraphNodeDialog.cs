...
public class VoxelGraphNodeDialog
{
	// Engine object used for calling engine methods
	protected ConfirmationDialog _object;

	public VoxelGraphNodeDialog() : this(NativeName)
	{
	}
	protected VoxelGraphNodeDialog(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelGraphNodeDialog(Variant variant) : this((ConfirmationDialog) variant)
	{
	}
	protected VoxelGraphNodeDialog([NotNull] ConfirmationDialog @object)
	{
		_object = @object;
	}

	public static implicit operator ConfirmationDialog(VoxelGraphNodeDialog self) => self?._object;
	public static implicit operator Variant(VoxelGraphNodeDialog self) => self?._object;
	public static explicit operator VoxelGraphNodeDialog(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelGraphNodeDialog";
	...
	public event Action<int> NodeSelected
	{
		add
		{
			Connect(SignalName.NodeSelected, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.NodeSelected, Callable.From(value));
		}
	}
	...
	public event Action<string> FileSelected
	{
		add
		{
			Connect(SignalName.FileSelected, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.FileSelected, Callable.From(value));
		}
	}
