...
public class ZN_EditorPlugin
{
	// Engine object used for calling engine methods
	protected EditorPlugin _object;

	public ZN_EditorPlugin() : this(NativeName)
	{
	}
	protected ZN_EditorPlugin(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ZN_EditorPlugin(Variant variant) : this((EditorPlugin) variant)
	{
	}
	protected ZN_EditorPlugin([NotNull] EditorPlugin @object)
	{
		_object = @object;
	}

	public static implicit operator EditorPlugin(ZN_EditorPlugin self) => self?._object;
	public static implicit operator Variant(ZN_EditorPlugin self) => self?._object;
	public static explicit operator ZN_EditorPlugin(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "ZN_EditorPlugin";
