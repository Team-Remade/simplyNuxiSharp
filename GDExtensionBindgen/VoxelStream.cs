...
public class VoxelStream
{
	...
	public VoxelStream() : this(NativeName)
	{
	}
	protected VoxelStream(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelStream(Variant variant) : this((Resource) variant)
	{
	}
	protected VoxelStream([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(VoxelStream self) => self?._object;
	public static implicit operator Variant(VoxelStream self) => self?._object;
	public static explicit operator VoxelStream(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : Resource.PropertyName
	{
		public static readonly StringName SaveGeneratorOutput = "save_generator_output";
		public static readonly StringName CompressionMode = "compression_mode";
	}

	public class MethodName : Resource.MethodName
	{
		public static readonly StringName LoadVoxelBlock = "load_voxel_block";
		public static readonly StringName SaveVoxelBlock = "save_voxel_block";
		public static readonly StringName GetUsedChannelsMask = "get_used_channels_mask";
		public static readonly StringName SetSaveGeneratorOutput = "set_save_generator_output";
		public static readonly StringName GetSaveGeneratorOutput = "get_save_generator_output";
		public static readonly StringName GetBlockSize = "get_block_size";
		public static readonly StringName Flush = "flush";
		public static readonly StringName GetCompressionMode = "get_compression_mode";
		public static readonly StringName SetCompressionMode = "set_compression_mode";
	}
	...
	private static readonly StringName NativeName = "VoxelStream";
	...
	public bool SaveGeneratorOutput
	{
		get => (bool)_object.Get(PropertyName.SaveGeneratorOutput);
		set => _object.Set(PropertyName.SaveGeneratorOutput, value);
	}

	public int CompressionMode
	{
		get => (int)_object.Get(PropertyName.CompressionMode);
		set => _object.Set(PropertyName.CompressionMode, value);
	}
	...
	public VoxelStream.ResultCode LoadVoxelBlock(VoxelBuffer @out_buffer, Godot.Vector3I @block_position, int @lod_index)
	{
		return (VoxelStream.ResultCode)(int)_object.Call(MethodName.LoadVoxelBlock, @out_buffer, @block_position, @lod_index);
	}

	public void SaveVoxelBlock(VoxelBuffer @buffer, Godot.Vector3I @block_position, int @lod_index)
	{
		_object.Call(MethodName.SaveVoxelBlock, @buffer, @block_position, @lod_index);
	}

	public int GetUsedChannelsMask()
	{
		return (int)_object.Call(MethodName.GetUsedChannelsMask);
	}

	public void SetSaveGeneratorOutput(bool @enabled)
	{
		_object.Call(MethodName.SetSaveGeneratorOutput, @enabled);
	}

	public bool GetSaveGeneratorOutput()
	{
		return (bool)_object.Call(MethodName.GetSaveGeneratorOutput);
	}

	public Godot.Vector3 GetBlockSize()
	{
		return (Godot.Vector3)_object.Call(MethodName.GetBlockSize);
	}

	public void Flush()
	{
		_object.Call(MethodName.Flush);
	}

	public VoxelBlockSerializer.Compression GetCompressionMode()
	{
		return (VoxelBlockSerializer.Compression)(int)_object.Call(MethodName.GetCompressionMode);
	}

	public void SetCompressionMode(VoxelBlockSerializer.Compression @mode)
	{
		_object.Call(MethodName.SetCompressionMode, (int)@mode);
	}
