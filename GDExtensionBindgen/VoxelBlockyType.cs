...
public class VoxelBlockyType
{
	// Engine object used for calling engine methods
	protected Resource _object;

	public VoxelBlockyType() : this(NativeName)
	{
	}
	protected VoxelBlockyType(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelBlockyType(Variant variant) : this((Resource) variant)
	{
	}
	protected VoxelBlockyType([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(VoxelBlockyType self) => self?._object;
	public static implicit operator Variant(VoxelBlockyType self) => self?._object;
	public static explicit operator VoxelBlockyType(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : Resource.PropertyName
	{
		public static readonly StringName UniqueName = "unique_name";
		public static readonly StringName BaseModel = "base_model";
		public static readonly StringName Attributes = "attributes";
		public static readonly StringName VariantModelsData = "_variant_models_data";
	}

	public class MethodName : Resource.MethodName
	{
		public static readonly StringName SetUniqueName = "set_unique_name";
		public static readonly StringName GetUniqueName = "get_unique_name";
		public static readonly StringName SetBaseModel = "set_base_model";
		public static readonly StringName GetBaseModel = "get_base_model";
		...
		public static readonly StringName GetRotationAttribute = "get_rotation_attribute";
		public static readonly StringName SetVariantModel = "set_variant_model";
	}
	...
	private static readonly StringName NativeName = "VoxelBlockyType";

	#region Integer Constants

	public const long MaxAttributes = 4L;

	#endregion

	#region Properties

	public Godot.StringName UniqueName
	{
		get => (Godot.StringName)_object.Get(PropertyName.UniqueName);
		set => _object.Set(PropertyName.UniqueName, value);
	}

	public VoxelBlockyModel BaseModel
	{
		get => (VoxelBlockyModel)_object.Get(PropertyName.BaseModel);
		set => _object.Set(PropertyName.BaseModel, value);
	}

	public Godot.Collections.Array Attributes
	{
		get => (Godot.Collections.Array)_object.Get(PropertyName.Attributes);
		set => _object.Set(PropertyName.Attributes, value);
	}

	public Godot.Collections.Array VariantModelsData
	{
		get => (Godot.Collections.Array)_object.Get(PropertyName.VariantModelsData);
		set => _object.Set(PropertyName.VariantModelsData, value);
	}
	...
	public void SetUniqueName(Godot.StringName @name)
	{
		_object.Call(MethodName.SetUniqueName, @name);
	}

	public Godot.StringName GetUniqueName()
	{
		return (Godot.StringName)_object.Call(MethodName.GetUniqueName);
	}

	public void SetBaseModel(VoxelBlockyModel @model)
	{
		_object.Call(MethodName.SetBaseModel, @model);
	}

	public VoxelBlockyModel GetBaseModel()
	{
		return (VoxelBlockyModel)_object.Call(MethodName.GetBaseModel);
	}

	public void SetAttributes(Godot.Collections.Array @attributes)
	{
		_object.Call(MethodName.SetAttributes, @attributes);
	}

	public Godot.Collections.Array GetAttributes()
	{
		return (Godot.Collections.Array)_object.Call(MethodName.GetAttributes);
	}

	public VoxelBlockyAttribute GetRotationAttribute()
	{
		return (VoxelBlockyAttribute)_object.Call(MethodName.GetRotationAttribute);
	}

	public void SetVariantModel(Godot.Collections.Array @key, VoxelBlockyModel @model)
	{
		_object.Call(MethodName.SetVariantModel, @key, @model);
	}
