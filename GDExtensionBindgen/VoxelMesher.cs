...
public class VoxelMesher
{
	...
	public VoxelMesher() : this(NativeName)
	{
	}
	protected VoxelMesher(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelMesher(Variant variant) : this((Resource) variant)
	{
	}
	protected VoxelMesher([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(VoxelMesher self) => self?._object;
	public static implicit operator Variant(VoxelMesher self) => self?._object;
	public static explicit operator VoxelMesher(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	{
		public static readonly StringName BuildMesh = "build_mesh";
		public static readonly StringName GetMinimumPadding = "get_minimum_padding";
		public static readonly StringName GetMaximumPadding = "get_maximum_padding";
	}
	...
	private static readonly StringName NativeName = "VoxelMesher";
	...
	public Mesh BuildMesh(VoxelBuffer @voxel_buffer, Godot.Collections.Array<Godot.Material> @materials, Godot.Collections.Dictionary @additional_data = null)
	{
		@additional_data ??= new();
		return (Mesh)_object.Call(MethodName.BuildMesh, @voxel_buffer, @materials, @additional_data);
	}

	public int GetMinimumPadding()
	{
		return (int)_object.Call(MethodName.GetMinimumPadding);
	}

	public int GetMaximumPadding()
	{
		return (int)_object.Call(MethodName.GetMaximumPadding);
	}
