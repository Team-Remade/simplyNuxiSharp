...
public class VoxelGeneratorMultipassCacheViewer
{
	// Engine object used for calling engine methods
	protected Control _object;

	public VoxelGeneratorMultipassCacheViewer() : this(NativeName)
	{
	}
	protected VoxelGeneratorMultipassCacheViewer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelGeneratorMultipassCacheViewer(Variant variant) : this((Control) variant)
	{
	}
	protected VoxelGeneratorMultipassCacheViewer([NotNull] Control @object)
	{
		_object = @object;
	}

	public static implicit operator Control(VoxelGeneratorMultipassCacheViewer self) => self?._object;
	public static implicit operator Variant(VoxelGeneratorMultipassCacheViewer self) => self?._object;
	public static explicit operator VoxelGeneratorMultipassCacheViewer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelGeneratorMultipassCacheViewer";
