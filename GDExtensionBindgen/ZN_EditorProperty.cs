...
public class ZN_EditorProperty
{
	// Engine object used for calling engine methods
	protected EditorProperty _object;

	public ZN_EditorProperty() : this(NativeName)
	{
	}
	protected ZN_EditorProperty(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ZN_EditorProperty(Variant variant) : this((EditorProperty) variant)
	{
	}
	protected ZN_EditorProperty([NotNull] EditorProperty @object)
	{
		_object = @object;
	}

	public static implicit operator EditorProperty(ZN_EditorProperty self) => self?._object;
	public static implicit operator Variant(ZN_EditorProperty self) => self?._object;
	public static explicit operator ZN_EditorProperty(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : EditorProperty.PropertyName
	{

	}

	public class MethodName : EditorProperty.MethodName
	{

	}

	public class SignalName : EditorProperty.SignalName
	{

	}

	private static readonly StringName NativeName = "ZN_EditorProperty";
	...
	{
		get => _object.Label;
		set => _object.Label = value;
	}

	public bool ReadOnly
	{
		get => _object.ReadOnly;
		set => _object.ReadOnly = value;
	}

	public bool DrawLabel
	{
		get => _object.DrawLabel;
		set => _object.DrawLabel = value;
	}

	public bool DrawBackground
	{
		get => _object.DrawBackground;
		set => _object.DrawBackground = value;
	}

	public bool Checkable
	{
		get => _object.Checkable;
		set => _object.Checkable = value;
	}

	public bool Checked
	{
		get => _object.Checked;
		set => _object.Checked = value;
	}

	public bool DrawWarning
	{
		get => _object.DrawWarning;
		set => _object.DrawWarning = value;
	}

	public bool Keying
	{
		get => _object.Keying;
		set => _object.Keying = value;
	}

	public bool Deletable
	{
		get => _object.Deletable;
		set => _object.Deletable = value;
	}
	...
	{
		get => _object.UseFolding;
		set => _object.UseFolding = value;
	}

	public float NameSplitRatio
	{
		get => _object.NameSplitRatio;
		set => _object.NameSplitRatio = value;
	}
	...
	public void SetDrawLabel(bool @draw_label)
	{
		_object.SetDrawLabel(@draw_label);
	}

	public bool IsDrawLabel()
	{
		return _object.IsDrawLabel();
	}

	public void SetDrawBackground(bool @draw_background)
	{
		_object.SetDrawBackground(@draw_background);
	}

	public bool IsDrawBackground()
	{
		return _object.IsDrawBackground();
	}

	public void SetCheckable(bool @checkable)
	{
		_object.SetCheckable(@checkable);
	}

	public bool IsCheckable()
	{
		return _object.IsCheckable();
	}

	public void SetChecked(bool @checked)
	{
		_object.SetChecked(@checked);
	}

	public bool IsChecked()
	{
		return _object.IsChecked();
	}

	public void SetDrawWarning(bool @draw_warning)
	{
		_object.SetDrawWarning(@draw_warning);
	}

	public bool IsDrawWarning()
	{
		return _object.IsDrawWarning();
	}

	public void SetKeying(bool @keying)
	{
		_object.SetKeying(@keying);
	}

	public bool IsKeying()
	{
		return _object.IsKeying();
	}

	public void SetDeletable(bool @deletable)
	{
		_object.SetDeletable(@deletable);
	}

	public bool IsDeletable()
	{
		return _object.IsDeletable();
	}

	public Godot.StringName GetEditedProperty()
	{
		return _object.GetEditedProperty();
	}

	public GodotObject GetEditedObject()
	{
		return _object.GetEditedObject();
	}

	public void UpdateProperty()
	{
		_object.UpdateProperty();
	}

	public void AddFocusable(Control @control)
	{
		_object.AddFocusable(@control);
	}

	public void SetBottomEditor(Control @editor)
	{
		_object.SetBottomEditor(@editor);
	}
	...
	public void SetUseFolding(bool @use_folding)
	{
		_object.SetUseFolding(@use_folding);
	}

	public bool IsUsingFolding()
	{
		return _object.IsUsingFolding();
	}

	public void SetNameSplitRatio(float @ratio)
	{
		_object.SetNameSplitRatio(@ratio);
	}

	public float GetNameSplitRatio()
	{
		return _object.GetNameSplitRatio();
	}
	...
	{
		_object.Select(@focusable);
	}

	public void SetObjectAndProperty(GodotObject @object, Godot.StringName @property)
	{
		_object.SetObjectAndProperty(@object, @property);
	}

	public void SetLabelReference(Control @control)
	{
		_object.SetLabelReference(@control);
	}

	public void EmitChanged(Godot.StringName @property, Variant @value, Godot.StringName @field = null, bool @changing = false)
	{
		@field ??= "";
		_object.EmitChanged(@property, @value, @field, @changing);
	}
	...
	public event Action<Godot.StringName, Variant, Godot.StringName, bool> PropertyChanged
	{
		add
		{
			Connect(SignalName.PropertyChanged, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.PropertyChanged, Callable.From(value));
		}
	}

	public event Action<string[], Godot.Collections.Array> MultiplePropertiesChanged
	{
		add
		{
			Connect(SignalName.MultiplePropertiesChanged, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.MultiplePropertiesChanged, Callable.From(value));
		}
	}

	public event Action<Godot.StringName> PropertyKeyed
	{
		add
		{
			Connect(SignalName.PropertyKeyed, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.PropertyKeyed, Callable.From(value));
		}
	}

	public event Action<Godot.StringName> PropertyDeleted
	{
		add
		{
			Connect(SignalName.PropertyDeleted, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.PropertyDeleted, Callable.From(value));
		}
	}

	public event Action<Godot.StringName, Variant> PropertyKeyedWithValue
	{
		add
		{
			Connect(SignalName.PropertyKeyedWithValue, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.PropertyKeyedWithValue, Callable.From(value));
		}
	}

	public event Action<Godot.StringName, bool> PropertyChecked
	{
		add
		{
			Connect(SignalName.PropertyChecked, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.PropertyChecked, Callable.From(value));
		}
	}
	...
	public event Action PropertyOverridden
	{
		add
		{
			Connect(SignalName.PropertyOverridden, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.PropertyOverridden, Callable.From(value));
		}
	}

	public event Action<Godot.StringName, bool> PropertyFavorited
	{
		add
		{
			Connect(SignalName.PropertyFavorited, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.PropertyFavorited, Callable.From(value));
		}
	}

	public event Action<Godot.StringName, bool> PropertyPinned
	{
		add
		{
			Connect(SignalName.PropertyPinned, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.PropertyPinned, Callable.From(value));
		}
	}

	public event Action<Godot.StringName, bool> PropertyCanRevertChanged
	{
		add
		{
			Connect(SignalName.PropertyCanRevertChanged, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.PropertyCanRevertChanged, Callable.From(value));
		}
	}

	public event Action<string, Resource> ResourceSelected
	{
		add
		{
			Connect(SignalName.ResourceSelected, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.ResourceSelected, Callable.From(value));
		}
	}

	public event Action<Godot.StringName, int> ObjectIdSelected
	{
		add
		{
			Connect(SignalName.ObjectIdSelected, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.ObjectIdSelected, Callable.From(value));
		}
	}

	public event Action<string, int> Selected
	{
		add
		{
			Connect(SignalName.Selected, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.Selected, Callable.From(value));
		}
	}
