...
public class VoxelColorPalette
{
	// Engine object used for calling engine methods
	protected Resource _object;

	public VoxelColorPalette() : this(NativeName)
	{
	}
	protected VoxelColorPalette(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelColorPalette(Variant variant) : this((Resource) variant)
	{
	}
	protected VoxelColorPalette([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(VoxelColorPalette self) => self?._object;
	public static implicit operator Variant(VoxelColorPalette self) => self?._object;
	public static explicit operator VoxelColorPalette(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "VoxelColorPalette";

	#region Integer Constants

	public const long MaxColors = 256L;

	#endregion

	#region Properties

	public Godot.Color[] Colors
	{
		get => (Godot.Color[])_object.Get(PropertyName.Colors);
		set => _object.Set(PropertyName.Colors, value);
	}

	public int[] Data
	{
		get => (int[])_object.Get(PropertyName.Data);
	...
	public void SetColor(int @index, Godot.Color @color)
	{
		_object.Call(MethodName.SetColor, @index, @color);
	}

	public Godot.Color GetColor(int @index)
	{
		return (Godot.Color)_object.Call(MethodName.GetColor, @index);
	}

	public void SetColors(Godot.Color[] @colors)
	{
		_object.Call(MethodName.SetColors, @colors);
	}

	public Godot.Color[] GetColors()
	{
		return (Godot.Color[])_object.Call(MethodName.GetColors);
	}

	public void SetData(int[] @d)
	{
		_object.Call(MethodName.SetData, @d);
	}

	public int[] GetData()
	{
		return (int[])_object.Call(MethodName.GetData);
	}
