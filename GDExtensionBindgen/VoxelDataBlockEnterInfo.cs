...
public class VoxelDataBlockEnterInfo
{
	// Engine object used for calling engine methods
	protected GodotObject _object;

	public VoxelDataBlockEnterInfo() : this(NativeName)
	{
	}
	protected VoxelDataBlockEnterInfo(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected VoxelDataBlockEnterInfo(Variant variant) : this((GodotObject) variant)
	{
	}
	protected VoxelDataBlockEnterInfo([NotNull] GodotObject @object)
	{
		_object = @object;
	}

	public static implicit operator GodotObject(VoxelDataBlockEnterInfo self) => self?._object;
	public static implicit operator Variant(VoxelDataBlockEnterInfo self) => self?._object;
	public static explicit operator VoxelDataBlockEnterInfo(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	public class MethodName : GodotObject.MethodName
	{
		...
		public static readonly StringName GetVoxels = "get_voxels";
		public static readonly StringName GetPosition = "get_position";
		public static readonly StringName GetLodIndex = "get_lod_index";
		public static readonly StringName AreVoxelsEdited = "are_voxels_edited";
	}
	...
	private static readonly StringName NativeName = "VoxelDataBlockEnterInfo";
	...
	{
		return (VoxelBuffer)_object.Call(MethodName.GetVoxels);
	}

	public Godot.Vector3I GetPosition()
	{
		return (Godot.Vector3I)_object.Call(MethodName.GetPosition);
	}
	...
	public bool AreVoxelsEdited()
	{
		return (bool)_object.Call(MethodName.AreVoxelsEdited);
	}
